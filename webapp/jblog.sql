...
SET DEFINE OFF;
Insert into JBLOG.BLOG (ID,BLOGTITLE,LOGOFILE) values ('test2','조경환',null);
Insert into JBLOG.BLOG (ID,BLOGTITLE,LOGOFILE) values ('test1','홍길동의 test blog#2','1613918647608a20536f8-0ba8-43c4-bbd7-4dec9b855143.jpg');
...
SET DEFINE OFF;
Insert into JBLOG.USERS (USERNO,ID,USERNAME,PASSWORD,JOINDATE) values (1,'test1','홍길동','1234',to_date('21/02/21','RR/MM/DD'));
Insert into JBLOG.USERS (USERNO,ID,USERNAME,PASSWORD,JOINDATE) values (2,'test2','조경환','1234',to_date('21/02/21','RR/MM/DD'));
--------------------------------------------------------
